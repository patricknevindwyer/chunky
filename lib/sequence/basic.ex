defmodule Chunky.Sequence.Basic do
  ...
  @doc sequence: "Whole numbers: [1, 2, 3, 4, 5, ...]",
       references: [
         {:wolfram, :positive_integer, "http://mathworld.wolfram.com/PositiveInteger.html"},
         {:wikipedia, :natural_number, "https://en.wikipedia.org/wiki/Natural_number"}
       ]
  ...
  @doc sequence: "Empty sequence: []",
       references: [{:wolfram, :empty_set, "http://mathworld.wolfram.com/EmptySet.html"}]
  def create_sequence_empty(_opts) do
    sequence_for_list([])
  end

  @doc sequence: "Decimal digits: [0, 1, 2, 3, 4, ...]",
       references: [{:wikipedia, :decimal_digit, "https://en.wikipedia.org/wiki/Numerical_digit"}]
