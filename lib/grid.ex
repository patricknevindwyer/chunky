defmodule Chunky.Grid do
    ...
    def new(width, height, fun) when is_integer(width) and is_integer(height) and is_function(fun, 1) do
    ...
    def valid_coordinate?(%Grid{}=grid, {x, y}) when is_integer(x) and is_integer(y), do: valid_coordinate?(grid, x, y)
