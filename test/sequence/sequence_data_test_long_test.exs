defmodule Chunky.SequenceDataTestLong do
  ...
  @sequences [
    ...
    %{
      ...
      sequence: :a069276,
      opts: [],
      values: [32768, 49152, 73728, 81920, 110_592, 114_688, 122_880, 165_888, 172_032, 180_224],
      finite: false,
      first_index: 1
    },
    %{
      ...
      sequence: :a069277,
      opts: [],
      values: [65536, 98304, 147_456, 163_840, 221_184],
      finite: false,
      first_index: 1,
      take_values: 5
    },
    %{
      ...
      sequence: :a069278,
      opts: [],
      values: [131_072, 196_608, 294_912, 327_680],
      finite: false,
      first_index: 1,
      take_values: 4
    },
    %{
      ...
      sequence: :a069279,
      opts: [],
      values: [262_144, 393_216, 589_824],
      finite: false,
      first_index: 1,
      take_values: 3
    },
